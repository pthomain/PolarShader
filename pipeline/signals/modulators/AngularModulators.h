...
#ifndef LED_SEGMENTS_PIPELINE_SIGNALS_MODULATORS_ANGULAR_H
#define LED_SEGMENTS_PIPELINE_SIGNALS_MODULATORS_ANGULAR_H
...
#endif //LED_SEGMENTS_PIPELINE_SIGNALS_MODULATORS_ANGULAR_H
