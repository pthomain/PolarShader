...
- **Internal Units Only:** Specialized units like `CartQ24_8` must be encapsulated as implementation details within specific patterns and not exposed in the pipeline interfaces.
