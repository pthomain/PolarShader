...
## Context
The project uses many specialized fixed-point units (`TrigQ0_16`, `SFracQ0_16`, etc.) that are structurally identical but used in different contexts. Merging these reduces complexity and improves developer ergonomics.

## Requirements
- **Merge TrigQ0_16:** Replace all usages of `TrigQ0_16` with `SFracQ0_16`.
