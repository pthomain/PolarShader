...
## Context
The project uses many specialized fixed-point units (`TrigQ0_16`, `SQ0_16`, etc.) that are structurally identical but used in different contexts. Merging these reduces complexity and improves developer ergonomics.

## Requirements
- **Merge TrigQ0_16:** Replace all usages of `TrigQ0_16` with `SQ0_16`.
