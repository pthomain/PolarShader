...
#ifndef POLAR_SHADER_PIPELINE_SIGNALS_MODULATORS_SCALAR_H
#define POLAR_SHADER_PIPELINE_SIGNALS_MODULATORS_SCALAR_H
...
#endif //POLAR_SHADER_PIPELINE_SIGNALS_MODULATORS_SCALAR_H
