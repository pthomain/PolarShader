...
#ifndef POLAR_SHADER_PIPELINE_SIGNALS_MOTIONBUILDER_H
#define POLAR_SHADER_PIPELINE_SIGNALS_MOTIONBUILDER_H
...
#endif //POLAR_SHADER_PIPELINE_SIGNALS_MOTIONBUILDER_H
