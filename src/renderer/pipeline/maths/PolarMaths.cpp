...
namespace PolarShader {
    ...
    fl::pair<AngleQ0_16, FracQ0_16> cartesianToPolar(fl::i32 x, fl::i32 y) {
        ...
        AngleQ0_16 angle_units = angleAtan2TurnsApprox(y16, x16);
        int32_t dx = x16;
        int32_t dy = y16;
        uint64_t radius_squared = static_cast<uint64_t>(dx * dx) + static_cast<uint64_t>(dy * dy);
        uint64_t magnitude_raw = scalarSqrtU64(radius_squared);
